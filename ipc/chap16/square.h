...
#define SQUAREPROG 1
extern  square_out * squareprog_1(square_in *, CLIENT *);
extern  square_out * squareprog_1_svc(square_in *, struct svc_req *);
extern int square_prog_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define SQUAREPROG 1
extern  square_out * squareprog_1();
extern  square_out * squareprog_1_svc();
